...
const AddGuitarScreen = () => {
  ...
  const submitForm = async (e) => {
    ...
    if (!fretboardMaterial)
      newErrors.fretboardMaterial = "Fretboard Material is required";
    ...
    try {
      const response = await fetch(
        API_ROUTES.BASE_URL + API_ROUTES.POST_ADD_GUITAR,
        {
          method: "POST",
      ...
      >
        ...
        >
          ...
          <FormControl fullWidth error={!!errors.numberOfFrets}>
            ...
            <Select value={numberOfFrets} onChange={handleFretChange} fullWidth>
